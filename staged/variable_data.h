...
namespace xdataset
{
    ...
    public:
        ...
        {
            // 1) Resolve retained dimensions (drop Equal dims),
            // 2) collect matches + projected indices in one pass,
            // 3) copy selected rows,
            // 4) rebuild projected spec.
